...
public class Hsi {
    ...
    public static void executarHsi(BufferedImage img) throws IOException{
        ...
        for (int x = 0; x < img.getWidth(); x++) {
         ...
         File out = new File("C:\\Users\\Mateus\\Desktop\\Imagens\\H.jpg");
                        ImageIO.write(redImage, "JPG", out);
                    out = new File("C:\\Users\\Mateus\\Desktop\\Imagens\\S.jpg");
                        ImageIO.write(greenImage, "JPG", out);
                    out = new File("C:\\Users\\Mateus\\Desktop\\Imagens\\I.jpg");
